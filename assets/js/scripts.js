   ...
   */
   ...
   jQuery(document).ready(function () {
      ...
      function expandSidebar() {
         var body = jQuery('body');
         if (body.hasClass('sidebar-menu-collapsed')) {
            jQuery('.toggle-btn').click(); // Simulate a click on the toggle button to expand the sidebar
         }
      }

      // Event listener for <a> inside <li> with class 'menu-list'
      jQuery('.menu-list > a').click(function (event) {
         event.preventDefault(); // Prevent default anchor behavior (navigation)
         expandSidebar(); // Call the function to expand the sidebar
      });
   });
